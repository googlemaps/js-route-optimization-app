...
class RouteOptimizationClient {
    ...
    initialize() {
        ...
        this.routeOptimizationStub = this._gaxGrpc.createStub(this._opts.fallback ?
            ...
            this._protos.google.maps.routeoptimization.v1.RouteOptimization, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const routeOptimizationStubMethods = ['optimizeTours'];
