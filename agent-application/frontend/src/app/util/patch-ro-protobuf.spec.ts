...
import masterCanon from '../samples/master_test.json';
import masterNonCanon from '../samples/master_test_noncanonical.json';
import masterSolution from '../samples/master_solution.json';
import masterSolutionNonCanon from '../samples/master_solution_noncanonical.json';

describe('patch-ro-protobuf', () => {
  beforeAll(() => {
    configureProtobuf();
  });
